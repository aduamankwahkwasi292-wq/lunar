...
## Corpus Check
- 16 files · ~13,983,284 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 387 nodes · 656 edges · 24 communities (19 shown, 5 thin omitted)
...
Cohesion: 0.20
Nodes (15): crAppendBoard(), crCloseSearch(), crHandleMessage(), crNextSlide(), crPrefetchSlide(), crPrevSlide(), crRenderBoard(), crRunSearch() (+7 more)
...
Cohesion: 0.20
Nodes (15): continueNextChunk(), crTypeInto(), delay(), deliverLectureInChunks(), deliverNextChunksWithChecks(), fetchAndDeliverLecture(), formatLectureForVoice(), handleNameSubmit() (+7 more)
...
Cohesion: 0.21
Nodes (12): downsampleTo16k(), encodeWav(), finalizeUtterance(), flattenVad(), handleAudioFrame(), interruptLunar(), quitVoiceMode(), resetVad() (+4 more)
...
Cohesion: 0.50
Nodes (5): crAttr(), crLinksHTML(), crLoadImage(), crMediaHTML(), crTypeSlidePayload()

### Community 21 - "Community 21"
Cohesion: 0.24
Nodes (11): crBuildProgress(), crEnterReading(), crExit(), crFitRoom(), crInit(), crSetStatus(), enterClassroom(), formatFileSize() (+3 more)
